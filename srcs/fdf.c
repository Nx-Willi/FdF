...
/*   Updated: 2022/01/27 13:28:53 by wdebotte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_init_mlx(t_env *mlx)
{
 ...
 Please try again !", NULL, NULL, EXIT_FAILURE);
	mlx->win_width = 1920;
	mlx->win_height = 1080;
...
int	main(int args, char **argv)
{
 ...
 \"scale\"", NULL, NULL, EXIT_FAILURE));
	...
	ft_init_mlx(&mlx);
	if (args == 3 && ft_atoi(argv[2]) <= 0)
		ft_printf("Negative or null scale ? Let's doing auto-scale ...\n");
	if (args == 3 && ft_atoi(argv[2]) > 0)
